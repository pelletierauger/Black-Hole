...
//     c = c - smoothstep(r * 0.5, r * 0.5 - 0.1, d);
    ...
    vec3 col = CircleRGB(uv, p, 0.4, 0.2, vec3(1.0, 1.0, 0.0));
    col = col - CircleRGB(uv, p, 0.2, 0.1, vec3(1.0, 1.0, 1.0));
    col = col + CircleRGB(uv, p, 0.5, 0.1, vec3(0.4, 0.0, 0.0));
    ...
    col = col + CircleRGB(uv, vec2(0.35, -0.35), 0.4, 0.8, vec3(1.0, 0.0, 0.0));
    col = col + CircleRGB(uv, vec2(0.45, 0.15), 0.4, 0.8, vec3(0.8, 0.0, 0.0));
    col = col + CircleRGB(uv, vec2(-0.6, 0.3), 0.4, 0.8, vec3(0.8, 0.0, 0.0));
    col = col + CircleRGB(uv, vec2(-0.4, -0.1), 0.4, 0.8, vec3(0.8, 0.0, 0.0));
