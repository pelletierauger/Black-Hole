...
//      col = col + CircleRGB(uv, p, 0.3, 0.1, vec3(1.0, 0.1, 1.0) * 0.5) * 0.5;
    col = col - CircleRGB(uv, p2, 0.2, 0.1 * (1.0 + siz2 * 0.5), vec3(1.0, 1.0, 1.0));
    col = col + CircleRGB(uv, p3, 0.5 * (1.0 + siz * 0.1), 0.2, vec3(0.4, 0.0, 0.0));
//     col = col + CircleRGB(uv, vec2(0.1 * sin(t * 100.), 0.1 * cos(t * 100.)), 0.1, 0.1, vec3(0.4, 0.0, 0.0));
    ...
    col = col + CircleRGB(uv, (vec2(0.45, 0.15) + p3) * (1.0 - siz2 * 0.2), 0.4, 0.8, vec3(0.8, 0.0, 0.0));
    col = col + CircleRGB(uv, (vec2(-0.6, 0.3) + p2) * (1.0 - siz * 0.2), 0.4, 0.8, vec3(0.8, 0.0, 0.0));
    col = col + CircleRGB(uv, vec2(-0.4, -0.1) * (1.0 - siz2 * 0.2), 0.4, 0.8, vec3(0.8, 0.0, 0.0));
